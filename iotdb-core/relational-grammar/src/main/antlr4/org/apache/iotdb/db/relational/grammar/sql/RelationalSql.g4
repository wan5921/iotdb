...
nonReserved
    ...
    : ABSENT | ADD | ADMIN | AFTER | ALL | ANALYZE | ANY | ARCHIVE | ARRAY | ASC | AT | ATTRIBUTE | AUDIT | AUTH | AUTHORIZATION | AVAILABLE
    ...
    | SECURITY | SHOW | SINK | SOME | SOURCE | START | STATUS | STATS | STOP | SUBSCRIPTION | SUBSCRIPTIONS | SUBSET | SUBSTRING | SYSTEM
